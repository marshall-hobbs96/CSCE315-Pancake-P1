...
test_GraphicsEngine: AI.o Player.o GraphicsEngine.o Game.o
	g++-8.2.0 -std=c++2a -Wall -Wextra -pedantic -fsanitize=address,undefined,pointer-compare,pointer-subtract -fstack-clash-protection -g -fno-omit-frame-pointer -lncurses++ -lmenu -lpanel -lform -lutil -lncurses -I $(CATCH_SINGLE_INCLUDE):include -o test/test_GraphicsEngine AI.o Player.o GraphicsEngine.o Game.o test/test_GraphicsEngine.cpp 
